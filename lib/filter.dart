            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: RaisedButton(
                        color: click == 4 ? AppColors.pink : Colors.white,
                        onPressed: () {
                          setState(() {
                            click = 4;
                            selected = true;
              ...
              SliderTheme(
                data: SliderTheme.of(context).copyWith(
                  valueIndicatorColor: AppColors.pink,
              ...
              Container(
                ...
                child: Row(
                  children: [
                    RaisedButton(
                        color: clicked == 5 ? AppColors.pink : Colors.white,
                        onPressed: () {
                          setState(() {
                            clicked = 5;
                            selected = false;
                    ...
                    RaisedButton(
                        color: clicked ==6  ? AppColors.pink:Colors.white,
                        onPressed: () {
                          setState(() {
                            clicked=6;
                          });
                    ...
                    RaisedButton(
                        color: clicked == 7  ? AppColors.pink:Colors.white,
                        onPressed: () {
                          setState(() {
                            clicked=7;
                          });
